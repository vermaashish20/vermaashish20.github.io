...
| :--- | :--- | :--- | :--- |
| **Section Header** | `text-4xl` | `text-6xl` | Main section titles, such as "Core Expertise". |
| **Items-Header** | `text-xl` | `text-2xl` | Category groupings, such as "Generative AI & Agents". |
| **Items-Subheader** | `text-base` | `text-xl` | Item names, project names, or roles. |
| **Items-Body** | `text-sm` | `text-base` | Descriptions, bullet points, and tool lists. |
| **Labels / UI** | `text-[10px]` | `text-xs` | Nav links, project tags, and small lifecycle steps. |
...
- **Page Gutters**: `px-6` on mobile, `px-12` on tablet, `px-16` on desktop.

## 5. UI Rules
- **Text Color**: Always use `text-black` for readability.
- **Line Color**: Always use `border-black` or `bg-black` for internal component dividers.
- **Indicators**: Use Indigo 600 for active states.
- **Animations**:
